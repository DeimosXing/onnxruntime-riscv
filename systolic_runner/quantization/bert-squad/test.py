...
#QLinear int8 quantized
#session = ort.InferenceSession('../onnx_models/bert_squad_quantized.onnx')
#IntOps quantized
#session = ort.InferenceSession('../onnx_models/quantized_bert.onnx')
session = ort.InferenceSession('bertsquad10.onnx')
